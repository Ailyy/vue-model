  ...
  <div class="content">
    ...
    <div class="main-container">
      ...
      <div class="content-grid">
        <ContentSection title="公司新闻" :items="newsList" @item-click="handleNewsClick" />
        <ContentSection title="公司公告" :items="noticeList" @item-click="handleNoticeClick" />
        <ContentSection title="体系文件" :items="documentList" @item-click="handleDocumentClick" />
      </div>
    </div>
    <div class="el-login-footer">
        <span>Copyright © {{new Date().getFullYear()}} 武汉海德博创科技有限公司.</span>
    </div>
    <Modal
